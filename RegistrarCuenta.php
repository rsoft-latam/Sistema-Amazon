...
?>
  ...
  <tr>
      ...
      <td><select size="1" name="Tipo" id="Tipo">
        ...
        <option value="Administrador Amazon">Administrador Amazon</option>
        <option value="Administrador Sucursal">Administrador Sucursal</option>
      </select></td>
      <td></td>
 </tr>
 ...
 <tr>
     ...
     <td>&nbsp;</td>
     <td><label for="label4">Categoria:</label></td>
     <td>
	 
	 <select size="1" name="Categoria" id="Categoria">
...
<tr>
  <td><span class="Estilo3"><img src=<?php echo $op['foto'];?> width="60" height="55"></span></td>
